...
private struct MenuBarIcon: View {
    ...
    private static var leaf: NSImage? {
        let image = NSImage(named: "MenuBarLeaf") ?? {
            guard let url = Bundle.main.url(forResource: "MenuBarLeaf", withExtension: "png") else {
                return nil
            }
